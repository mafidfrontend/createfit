...
export type DesignType = 'existing' | 'uploaded'
...
export interface Design { type: DesignType; existingDesignId: string | null; existingDesignName: string | null; uploadedImageUrl: string | null; uploadedImageName: string | null; additionalPrice: number }
...
export interface SizeSelection { type: SizeType; standardSize: string | null; customMeasurements: CustomMeasurements | null }
export interface Delivery { city: string; address: string; comment: string; price: number }
export interface Customer { telegramId: number | null; firstName: string; lastName: string; username: string | null; phone: string }
